	...
	public function html( $type = '' ) {
		...
		switch ( $name ) {
			case 'thumbnails' :
				...
				if( is_array($thumbs) ){
					$return .= '<button class="select-thumbs xbox-btn xbox-btn-pink" type="button">' . __('Add thumbnails', 'wpscore_lang') . ' <i class="xbox-icon xbox-icon-upload"></i></button>';
